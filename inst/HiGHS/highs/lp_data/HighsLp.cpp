...
#ifndef NDEBUG
  if (!equal_matrix) Rprintf("HighsLp::equalButForNames: Unequal matrix\n");
#endif
...
#ifndef NDEBUG
  if (!equal_vectors) Rprintf("HighsLp::equalButForNames: Unequal vectors\n");
#endif
...
#ifndef NDEBUG
  if (!equal) Rprintf("HighsLp::equalScaling: Unequal scaling\n");
#endif
  return equal;
}
